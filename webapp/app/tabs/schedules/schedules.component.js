...
let SchedulesComponent = class SchedulesComponent extends items_component_1.ItemsComponent {
    constructor(http) {
        super(http);
        this.itemsUri = `/getschedules`;
        this.updateUri = `/updateschedule?scheduleid=`;
    }
    isOn(itemId) {
        return false;
    }
