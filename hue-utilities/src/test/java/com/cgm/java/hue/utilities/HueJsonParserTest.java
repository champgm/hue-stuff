...
public class HueJsonParserTest {
    ...
    public void testConversionOfSingleScene() {
        final String actualSceneJson = "{\"name\":\"Test Scene\"," +
                                       "\"lights\":[\"1\",\"2\"]," +
                                       "\"owner\":\"1234\"," +
                                       "\"recycle\":true," +
                                       "\"locked\":false," +
        ...
        final String acceptableFormatJson = "{\"id\":null," +
                                            "\"name\":\"scenename\"," +
                                            "\"lights\":[\"1\",\"2\"]," +
                                            "\"owner\":null," +
                                            "\"recycle\":null," +
    ...
    public void testConversionOfFullSceneDump() {
        final String fullDump = "{\"738e3c2af-off-0\":{\"name\":\"BR - on off 1448596157000\",\"lights\":[\"4\",\"5\"],\"owner\":\"\",\"recycle\":true,\"locked\":false,\"appdata\":{},\"picture\":\"\",\"lastupdated\":\"2016-01-12T04:36:52\",\"version\":1}," +
    ...
    public void testConversionOfSingleJsonToLight() throws Exception {
        final String lightJson = "{\"state\": {\"on\":false," +
                                 "\"bri\":254," +
                                 "\"alert\":\"none\"," +
                                 "\"reachable\":true}, " +
                                 "\"type\": \"Dimmable light\", " +
    ...
    public void testConversionOfSingleJsonToGroup() throws Exception {
        final String lightJson = "{\"name\":\"Bedroom\"," +
                                 "\"lights\":[\"5\",\"4\"]," +
                                 "\"type\":\"LightGroup\"," +
    ...
    public void testConversionOfJsonToState() throws Exception {
        final String stateJson = " {\"on\":false," +
                                 "\"bri\":254," +
                                 "\"alert\":\"none\"," +
                                 "\"reachable\":true}";
