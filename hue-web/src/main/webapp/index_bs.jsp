    ...
    <div id="lights" class="tab-pane fade">
      ...
      <c:choose>
		<c:when test="${light.getState().getOn()}">
			<input type="checkbox" checked class="light" id="${light.getId()}" data-toggle="toggle"
      		data-on="<br/>${light.getName()}" data-off="<br/>${light.getName()}" data-width="180" 
      		data-height="75" data-size="normal" data-style="ios" data-onstyle="success" data-offstyle="default">
		</c:when>		
		<c:when test="${!light.getState().getOn()}">
      	<input type="checkbox" class="light" id="${light.getId()}" data-toggle="toggle"
      		data-on="<br/>${light.getName()}" data-off="<br/>${light.getName()}" data-width="180" 
      		data-height="75" data-size="normal" data-style="ios" data-onstyle="success" data-offstyle="default">
      	</c:when>
      </c:choose>
