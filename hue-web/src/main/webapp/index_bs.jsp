...
<body>
     ...
     <div class="container-fluid">
          ...
          <ul class="nav nav-tabs">
               ...
               <li>
                    <a data-toggle="tab" href="#lights">Lights</a>
               </li>
               <li>
                    <a data-toggle="tab" href="#scenes">Scenes</a>
               </li>
               <li>
                    <a data-toggle="tab" href="#groups">Groups</a>
               </li>
               <li>
                    <a data-toggle="tab" href="#schedules">Schedules</a>
               </li>
               <li>
                    ...
                    <div class="row">
                         <c:forEach items="${lightlist}" var="light"
                              ...
                              <div class="col-sm-6 col-md-4">
                                   <c:choose>
                                        <c:when
                                             test="${light.getState().getOn()}">
                                             <input type="checkbox"
                                                  checked class="light"
                                                  id="${light.getId()}"
                                                  data-toggle="toggle"
                                                  data-on="<br/>${light.getName()}"
                                                  data-off="<br/>${light.getName()}"
                                                  data-width="180"
                                                  data-height="75"
                                                  data-size="normal"
                                                  data-style="ios"
                    ...
                    <div class="row">
                         <c:forEach items="${grouplist}" var="group"
                              ...
                              <div class="col-sm-6 col-md-4">
                                   <c:choose>
                                        <c:when
                                             test="${group.getAction().getOn()}">
                                             <input type="checkbox"
                                                  checked class="group"
                                                  id="${group.getId()}"
                                                  data-toggle="toggle"
                                                  data-on="<br/>${group.getName()}"
                                                  data-off="<br/>${group.getName()}"
                                                  data-width="180"
                                                  data-height="75"
                                                  data-size="normal"
                                                  data-style="ios"
